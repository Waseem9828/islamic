...
import { ChevronRight, LogOut, UserCog, Wallet, Loader2, Save, Camera, Shield, Crop } from 'lucide-react';
...
export function ProfileForm() {
    ...
    const handleAvatarUpload = async () => {
        if (!completedCrop || !imgRef.current || !user || !firestore) {
            toast.error("Crop is not complete or image not loaded.");
            return;
        }
        ...
        <Dialog open={isCropModalOpen} onOpenChange={setIsCropModalOpen}>
            <DialogContent className="max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>Adjust the image to get the perfect profile picture.</DialogDescription>
                </DialogHeader>
