...
import { getGroups, updateLuckyNumber } from '@/lib/store';
...
export default function ManageNumbersPage() {
  ...
  const handleUpdate = () => {
    ...
    updateLuckyNumber(selectedGroup, newNumber);
        ...
        <Card className="bg-muted/30">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <Button onClick={handleUpdate} disabled={!selectedGroup || !newNumber}>Update Number</Button>
                </div>
